//
//  BUDAdmob_PangleRewardCustomEventAdapter.m
//  AdmobAdapterDemo
//
...
#import "BUDAdmob_PangleRewardCustomEventAdapter.h"
#import <BUAdSDK/BUAdSDK.h>

@interface BUDAdmob_PangleRewardCustomEventAdapter ()<BURewardedVideoAdDelegate,GADMediationRewardedAd>
{
}
...
@property(nonatomic, getter=isOn) BOOL isInited;

@end



@implementation BUDAdmob_PangleRewardCustomEventAdapter
...
- (void)initSDK {
    ...
    self.isInited = YES;
    [BUAdSDKManager setAppID:@"7777777"];	//填写自己的AppID
    [BUAdSDKManager setCoppa:0];
    [BUAdSDKManager setGDPR:0];
    [BUAdSDKManager setLoglevel:BUAdSDKLogLevelDebug];

    NSString * const pangleExtDataString = @"[{\"name\":\"mediation\",\"value\":\"admob\"},{\"name\":\"adapter_version\",\"value\":\"1.2.1\"}]";
